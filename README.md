...
<p align="center">
  ...
  <a href="mailto:Teemu.Rekiranta1@gmail.com">
...
<p>
  ...
  <a href="https://www.terraform.io"><img src="https://skillicons.dev/icons?i=terraform" width="50" height="50" alt="Terraform"/></a>
  <a href="https://kubernetes.io"><img src="https://skillicons.dev/icons?i=kubernetes" width="50" height="50" alt="Kubernetes"/></a>
  <a href="https://www.docker.com"><img src="https://skillicons.dev/icons?i=docker" width="50" height="50" alt="Docker"/></a>
  <a href="https://www.linux.org"><img src="https://skillicons.dev/icons?i=linux" width="50" height="50" alt="Linux"/></a>
</p>

AWS, Google Cloud, Terraform, Kubernetes, Docker, Linux
...
<p>
  ...
  <a href="https://www.gnu.org/software/bash"><img src="https://skillicons.dev/icons?i=bash" width="50" height="50" alt="Bash"/></a>
</p>

Python, FastAPI, Flask, Node.js, TypeScript, Bash
...
### DevOps & CI/CD
<p>
  <a href="https://github.com/features/actions"><img src="https://skillicons.dev/icons?i=githubactions" width="50" height="50" alt="GitHub Actions"/></a>
  ...
  <a href="https://www.nginx.com"><img src="https://skillicons.dev/icons?i=nginx" width="50" height="50" alt="Nginx"/></a>
  <a href="https://www.ansible.com"><img src="https://skillicons.dev/icons?i=ansible" width="50" height="50" alt="Ansible"/></a>
</p>

GitHub Actions, Git, Grafana, Prometheus, Nginx, Ansible
...
<p>
  ...
  <a href="https://aws.amazon.com/dynamodb"><img src="https://skillicons.dev/icons?i=dynamodb" width="50" height="50" alt="DynamoDB"/></a>
  <a href="https://kafka.apache.org"><img src="https://skillicons.dev/icons?i=kafka" width="50" height="50" alt="Kafka"/></a>
  <a href="https://www.mongodb.com"><img src="https://skillicons.dev/icons?i=mongodb" width="50" height="50" alt="MongoDB"/></a>
  <a href="https://www.mysql.com"><img src="https://skillicons.dev/icons?i=mysql" width="50" height="50" alt="MySQL"/></a>
</p>

PostgreSQL, Redis, DynamoDB, Kafka, MongoDB, MySQL
...
<h3 align="center">
  <a href="https://github.com/Rekiranta/terraform-k8s-blueprints-ci">terraform-k8s-blueprints-ci</a>
</h3>

<p align="center">
  <img src="https://img.shields.io/badge/Infrastructure-844FBA?style=flat-square" alt="Category"/>
</p>

<p align="center">
  Kubernetes infrastructure with Terraform and GitHub Actions CI pipeline for automated deployments
</p>
...
<h3 align="center">
  <a href="https://github.com/Rekiranta/streaming-redpanda-postgres">streaming-redpanda-postgres</a>
</h3>

<p align="center">
  <img src="https://img.shields.io/badge/Data_Streaming-DC382D?style=flat-square" alt="Category"/>
</p>

<p align="center">
  Event streaming pipeline with Redpanda (Kafka) and idempotent PostgreSQL sink for real-time data
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Redpanda-DC382D?style=flat-square&logo=redpanda&logoColor=white" alt="Redpanda"/>
...
<h3 align="center">
  <a href="https://github.com/Rekiranta/data-pipeline-elt-dbt">data-pipeline-elt-dbt</a>
</h3>

<p align="center">
  <img src="https://img.shields.io/badge/Data_Engineering-FF694B?style=flat-square" alt="Category"/>
</p>

<p align="center">
  Modern ELT pipeline with dbt transformations and Pandera data validation on DuckDB
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Pandera-3776AB?style=flat-square&logo=python&logoColor=white" alt="Pandera"/>
</p>
...
<h3 align="center">
  <a href="https://github.com/Rekiranta/localstack-sqs-dynamodb-iac">localstack-sqs-dynamodb-iac</a>
</h3>

<p align="center">
  <img src="https://img.shields.io/badge/Cloud_Simulation-FF9900?style=flat-square" alt="Category"/>
</p>

<p align="center">
  AWS SQS and DynamoDB infrastructure running locally with LocalStack and Terraform
</p>

<p align="center">
  <img src="https://img.shields.io/badge/LocalStack-4053D6?style=flat-square&logo=amazonaws&logoColor=white" alt="LocalStack"/>
  <img src="https://img.shields.io/badge/Terraform-844FBA?style=flat-square&logo=terraform&logoColor=white" alt="Terraform"/>
...
<h3 align="center">
  <a href="https://github.com/Rekiranta/devops-ci-demo">devops-ci-demo</a>
</h3>

<p align="center">
  <img src="https://img.shields.io/badge/CI%2FCD-2088FF?style=flat-square" alt="Category"/>
</p>

<p align="center">
  Flask REST API with comprehensive pytest testing and GitHub Actions CI/CD pipeline
</p>
...
<h3 align="center">
  <a href="https://github.com/Rekiranta/fastapi-redis-cache-api">fastapi-redis-cache-api</a>
</h3>

<p align="center">
  <img src="https://img.shields.io/badge/API_Development-009688?style=flat-square" alt="Category"/>
</p>

<p align="center">
  FastAPI REST API with Redis caching implementing cache-aside pattern for performance
</p>
